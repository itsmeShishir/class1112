...
function AllCategory() {
  ...
  return (
    <div className="w-[85vw] mx-auto mt-6">
      <h1 className="text-3xl font-extrabold text-center text-gray-800">All Categories</h1>

      {/* Loading State */}
      {loading && <p className="text-center text-lg font-semibold mt-4">Loading categories...</p>}
