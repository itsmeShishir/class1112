                ...
                return(
                    ...
                    <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                      <a href="#" className="shrink-0 md:order-1">
                        <img className="h-20 w-20 dark:hidden" src={images} alt="imac image" />
                        <img className="hidden h-20 w-20 dark:block" src={images} alt="imac image" />
                      </a>
                      ...
                      <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <button type="button" className="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500" onClick={() => dispatch(removeFromCart(item))}>
                            <svg className="me-1.5 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
